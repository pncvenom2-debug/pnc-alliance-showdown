        ...
        <div className="px-6 py-4 space-y-6">
          ...
          <div className={cn(
            ...
            <p className="text-sm leading-relaxed text-foreground/90 italic font-medium whitespace-pre-line">
              {quest.type === "gather" ? t.tips.gatherQuest : (quest.type === "rally" ? t.tips.rallyMonsterDens : (quest.type === "gear" ? t.tips.gearMaterials : (quest.type === "help" ? t.tips.helpAllies : (quest.note || t.modal.noTip))))}
            </p>
          </div>
        </div>
